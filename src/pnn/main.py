...
import utils
from models import LR, FM, PNN1, PNN2, FNN, CCPM, FFM

train_file = '../../output/pnn/train.txt'
test_file = '../../output/pnn/test.txt'
...
if algo in {'fnn', 'ccpm', 'pnn1', 'pnn2', 'pnn'}:
